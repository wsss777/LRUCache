...
var file_pb_wscache_proto_depIdxs = []int32{
	...
	1, // 3: pb.wsCache.Get:output_type -> pb.ResponseForGet
	1, // 4: pb.wsCache.Set:output_type -> pb.ResponseForGet
	2, // 5: pb.wsCache.Delete:output_type -> pb.ResponseForDelete
